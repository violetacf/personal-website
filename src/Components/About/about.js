        ...
        <div className="about">
          ...
          <div className="intro-text-container">
            <p>
              ...
              with limited communication, and I developed a passion for
              inclusion and accessibility. <br />I discovered programming last
              year through some online tutorials, which led me to enroll on a
              short course at the City of Bristol College, where I learnt the
              basics of Python. <br />I am one of the lucky people studying with
              the School of Code, where I am currently improving my JavaScript,
              CSS and HTML skills. <br />
